...
// Advertising duty: low (two-phase, fast then slow) or NimBLE's fast default
// throughout. Takes effect at once if the stack is advertising; safe to call
// before app_ble_init(). Driven by app_power.c.
